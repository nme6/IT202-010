            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="rolesDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/view_accounts.php'); ?>">View Accounts</a></li>
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/manage_users.php'); ?>">Manage Users</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if (is_logged_in()) : ?>
