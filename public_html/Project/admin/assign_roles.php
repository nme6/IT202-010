...
<div class="container-fluid col-lg-4 offset-lg-4">
    <h1 style="padding-top: 10px">Assign Roles</h1>
    <form method="POST">
        <input style="margin: 15px 0" class="form-control" type="search" name="username" placeholder="Username search" />
    ...
    <form method="POST">
                ...
                <tr>
                    ...
                    <td>
                        <?php foreach ($active_roles as $role) : ?>
                            <div>
                                <label class="form-label" for="role_<?php se($role, 'id'); ?>"><?php se($role, "name"); ?></label>
        ...
        <input style="margin: 15px 0" type="submit" class="mt-3 btn btn-primary" value="Toggle Roles" />
    </form>
</div>
<?php
//note we need to go up 1 more directory
