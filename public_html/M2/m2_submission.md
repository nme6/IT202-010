...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98120877/153787454-b8c4cbef-79f7-4ade-9d40-f8f078ac1794.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the correct output/solution for Problem #1 (Only output Odd values of the<br>Array under &quot;Odds output&quot;)<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I solved the problem by implementing a FOR loop that went through each<br>array and checked through an IF statement if the item it was indexing<br>was odd using modulo. In simpler terms, it went through each item in<br>the array, did &quot;item % 2&quot; and checked if &quot;item % 2 !=<br>0&quot; as checking if item modulo 2 not equaling 0 would confirm that<br>it is odd. If item modulo 2 is equal to 0, it is<br>even. After checking with the IF statement, if it returned true (or in<br>this case, ODD), it would echo the number being indexed from the array<br>with a comma and a space after it to separate the numbers and<br>not have them be a jumbled mess of numbers. (ex: &quot;13579&quot; vs &quot;1,<br>3, 5, 7, 9,&quot;). This applied to all arrays and worked properly.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98120877/153788232-6c1107bb-568c-47e5-8085-79db4013ed09.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the correct output/solution for Problem #2 (Only output the sum/total of the<br>array values by assigning it to the $total variable (the number must end<br>in 2 decimal places, if it ends in 1 it must have a<br>0 at the end))<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>For this problem, I implemented basically the same FOR loop used in problem<br>#1 but only for the adding part of the problem. This FOR loop<br>however has no IF statement and instead just takes each item from the<br>array and adds each item to $total until it reaches the end of<br>the array. This runs through all arrays and works properly. For the rounding<br>part of the problem I just did &quot;$total = round($total, 2)&quot;. The function<br>of round() in PHP takes 3 parameters: number, precision, and mode. In our<br>case, we only needed number and precision. For number, we use $total as<br>that is what is being rounded. For precision, we just type 2 as<br>the problem asks us to round to 2 decimal places (and that is<br>what precision does). This runs through all arrays and works properly.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98120877/153788995-93dee4cc-0dab-4108-836f-90fd03b7bc0d.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the correct output/solution for Problem #3 (Output the given values as positive<br>under the &quot;Positive Output&quot; message (the data otherwise shouldn&#39;t change))<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
